...
def main():
    ...
    classaccu = tnt.meter.ClassErrorMeter(topk=[1, 5], accuracy=True)
    ########
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for i, (data) in enumerate(train_loader, start=start_iter):
            ...
            ########
            classaccu.add(new_out.data, speaker_labels.data)
            ...
            if not args.silent:
                ...
                print('Epoch: [{0}][{1}/{2}]\t'
                      ...
                      .format((epoch + 1), (i + 1), len(train_loader), batch_time=batch_time, data_time=data_time,
                              loss=losses, car1=classaccu.value()[0], car2=classaccu.value()[1]))
                ########
        ...
        """
        print("\nFINAL EPOCH TRAINING RESULTS:", classaccu.value()[0], classaccu.value()[1],"\n")
        ########
        ...
        for i, (data) in enumerate(test_loader):  # test
            ...
            print('Validation Summary Epoch: [{0}]\t'
                  'Average CAR@1 {car1:.3f}\t'
                  'Average CAR@5 {car2:.3f}\t'
                  .format(epoch + 1, car1=classaccu.value()[0], car2=classaccu.value()[1]))
            """
            seq_length = out.size(0)
        ...
        ########
        print("\nFINAL EPOCH TEST RESULTS:", classaccu.value()[0], classaccu.value()[1],"\n")
        ########
