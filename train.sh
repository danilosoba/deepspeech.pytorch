...
--kernel 11 --stride 2 --crop_begin 400 --crop_end 0 | tee logs/full_crop400x0_conv11x2_arch400x4_lr0.05.txt
...
--kernel 11 --stride 2 --crop_begin 400 --crop_end 0 | tee logs/sum_crop400x0_conv11x2_arch400x4_lr0.005.txt
...
--kernel 11 --stride 2 --crop_begin 400 --crop_end 0 | tee logs/reg_crop400x0_conv11x2_arch400x4_lr0.05.txt
...
--kernel 11 --stride 2 --crop_begin 400 --crop_end 0 | tee logs/reg2_crop400x0_conv11x2_arch400x4_lr0.05.txt
