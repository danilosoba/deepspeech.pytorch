...
--loss_type full --learning-rate 0.05 --epochs 300 --hidden_layers 2 --hidden_size 600 --cnn_features 32 --kernel 11 --stride 3 \
--sample_proportion 0.8 --first_layer_type CONV --mfcc false #| tee spect_reg_lr0.05-0.99_train-prop0.8_test-full_arch-conv32-64x3x1.log

#LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libgomp.so.1 python train.py \
#--train_manifest data/mit_train_speaker_identification.csv --val_manifest data/mit_val_speaker_identification.csv --cuda --batch_size 20 \
#--loss_type full --learning-rate 0.05 --epochs 300 --hidden_layers 2 --hidden_size 600 --cnn_features 64 --kernel 11 --stride 3 \
#--sample_proportion 0.8 --first_layer_type CONV --mfcc false | tee spect_reg_lr0.05-0.99_train-prop0.8_test-full_arch-conv64-128x3x1.log

#LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libgomp.so.1 python train.py \
#--train_manifest data/mit_train_speaker_identification.csv --val_manifest data/mit_val_speaker_identification.csv --cuda --batch_size 20 \
#--loss_type full --learning-rate 0.05 --epochs 300 --hidden_layers 2 --hidden_size 600 --cnn_features 128 --kernel 11 --stride 3 \
#--sample_proportion 0.8 --first_layer_type CONV --mfcc false | tee spect_reg_lr0.05-0.99_train-prop0.8_test-full_arch-conv128-256x3x1.log

#LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libgomp.so.1 python train.py \
#--train_manifest data/mit_train_speaker_identification.csv --val_manifest data/mit_val_speaker_identification.csv --cuda --batch_size 20 \
#--loss_type full --learning-rate 0.05 --epochs 300 --hidden_layers 2 --hidden_size 600 --cnn_features 256 --kernel 11 --stride 3 \
#--sample_proportion 0.8 --first_layer_type CONV --mfcc false | tee spect_reg_lr0.05-0.99_train-prop0.8_test-full_arch-conv256-512x3x1.log
