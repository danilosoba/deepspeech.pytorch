...
--kernel 11 --stride 3 --crop_begin 200 --crop_end 200 #| tee logs/full_crop200x200_conv11x3_arch400x4_lr0.05.txt
...
--kernel 11 --stride 3 --crop_begin 200 --crop_end 200 #| tee logs/sum_crop200x200_conv11x3_arch400x4_lr0.005.txt
...
--kernel 11 --stride 3 --crop_begin 200 --crop_end 200 #| tee logs/reg_crop200x200_conv11x3_arch400x4_lr0.05.txt
