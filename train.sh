...
--kernel 11 --stride 3 --crop_begin 200 --crop_end 200 --sample_proportion 1.0 | tee logs/full_sample1.0_crop200x200_conv11x3_arch400x4_lr0.05.txt4
...
--kernel 11 --stride 3 --crop_begin 200 --crop_end 200 --sample_proportion 1.0 | tee logs/sum_sample1.0_crop200x200_conv11x3_arch400x4_lr0.005.txt4
...
--kernel 11 --stride 3 --crop_begin 200 --crop_end 200 --sample_proportion 1.0 | tee logs/reg_sample1.0_crop200x200_conv11x3_arch400x4_lr0.05.txt4
