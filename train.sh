...
--sample_proportion 0.8 --crop_begin 40 --crop_end 40 --first_layer_type CONV --mfcc false #| tee spect_reg_lr0.05-0.99_train-prop0.8_test-full_arch-cnn600x11x3-rnn1x600.log
